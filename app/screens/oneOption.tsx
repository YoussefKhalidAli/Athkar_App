  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <PanGestureHandler
        ...
        activeOffsetX={[-10, 10]} // Prevents horizontal swipes from interfering with vertical scrolling
        simultaneousHandlers={scrollViewRef} // Allow both gestures to work together
      >
